# Day 1: Python Fundamentals - Syntax, Variables, & Data Types
...
2. **Comments:** Used `#` for single-line notes and triple quotes `"""` for documentation.
3. **Variables & Case Sensitivity:** Variables are created the moment a value is assigned. `a` and `A` are two different variables.
